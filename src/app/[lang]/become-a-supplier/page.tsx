...
export default function BecomeASupplierPage() {
  return (
    <div className="flex flex-col min-h-screen">
      <Header />
      <main className="flex-grow bg-[#F9FAFB] py-16 px-4 relative overflow-hidden">
          ...
          <div className="bg-white rounded-[35px] shadow-2xl shadow-purple-900/5 border border-gray-100 p-8 sm:p-12">
            <div className="text-center mb-10">
              <h1 className="text-3xl sm:text-4xl font-black text-gray-900 mb-3 tracking-tight">
                Become a <span style={{ color: COLORS.primary }}>Supplier</span>
              </h1>
              <p className="text-gray-500 text-[15px] max-w-md mx-auto leading-relaxed">
                Join thousands of successful sellers on Buyology. Start your journey in just a few simple steps.
              </p>
            </div>

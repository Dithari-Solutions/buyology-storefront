...
export default function PaymentCallbackPage({ lang }: { lang: string }) {
    ...
    useEffect(() => {
        // Try to get transactionId from URL first (Paymob sometimes appends it)
        // Then from sessionStorage
        const txIdFromUrl = searchParams.get("transactionId") || searchParams.get("id");
